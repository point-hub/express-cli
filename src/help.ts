...
export class Help {
  static separatorLength = 10;
  static outputRoot = "";
  static output = "";

  static rootHelp(command: Command, options: Array<IOption | IOptionBoolean>) {
    ...
    const termsLength = DefaultTable.termsWidth(
      Help.commandTermLength(command.getCommands()),
      Help.optionTermLength(options)
    );
  ...
  static commandHelp(command: Command, currentCommand: BaseCommand) {
    // Usage
    ...
    const termsLength = DefaultTable.termsWidth(
      Help.argumentTermLength(currentCommand.arguments),
      Help.optionTermLength(currentCommand.options)
    );
